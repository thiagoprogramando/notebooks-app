        ...
        <div class="card mb-3">
            ...
            <div class="card-body d-flex justify-content-between flex-wrap gap-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="card-info">
                        <h5 class="mb-0">{{ $boards->count() }}</h5>
                        <p class="mb-0">Bancas</p>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-3">
                    <div class="avatar">
            ...
            <div class="list-group p-0 m-0">
                @foreach ($boards as $board)
                    <div class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer waves-effect waves-light">
                        <img src="{{ asset('assets/img/avatars/man.png') }}" alt="Conteúdo Imagem" class="rounded-circle me-3" width="40">
                        <div class="w-100">
